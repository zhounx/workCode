<template>
  <div class="form-submit-page">
    <div class="message-top">
      <h2>提交开户资料</h2>
      <home-step :stepActive="3" :step-list="stepList.mainlandStep"></home-step>
            ...
            <template #accountOpenFormImage>
              <div style="display: flex">
                <yk-upload
                  ...
                  @on-success="(event:any)=>{applyFormInfo.accountOpenFormImage=event.data;applyFormInfoRule?.validateField('accountOpenFormImage')}"
                ></yk-upload>
              </div>
            </template>
          </yk-form>
...
async function thirdSubmit() {
  ...
  let res: any = await mainlandApply.applyInfoAtThirdStep(
