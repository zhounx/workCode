...
//营业执照信息
export const licenseInfoFormItems = [
  {
    label: "营业执照",
    slot: "imageUrl",
    prop: "imageUrl",
  ...
  {
    label: "法人手持营业执照图片",
    slot: "legalHolderImage",
    prop: "legalHolderImage",
    width: "510px",
    rules: [
      {
        required: true,
        message: "请上传法人手持营业执照图片",
        trigger: "change",
      },
    ],
  },
  ...
  },
  {
    ...
    width: "510px",
    rules: [
      { required: true, message: "请输入企业注册地址", trigger: "change" },
    ],
  },
];
//法人信息
...
export const baseInfoFormItems = [
  ...
  },
  {
    ...
    width: "510px",
    rules: [{ required: true, message: "请输入企业英文名", trigger: "blur" }],
  },
  {
    label: "所属行业",
    type: "input",
...
export const settleInfoFormItems1 = [
  ...
  },
  {
    ...
    disabled: "disabled",
    rules: [
      { required: false, message: "请输入企业法人姓名", trigger: "blur" },
    ],
  },
  {
    label: "银行卡号",
...
export const shareholderInfosFormItems = [
  ...
  },
  {
    ...
    width: "510px",
    maxlength: 11,
    placeholder: "请输入该股东/实控人的手机号",
    rules: [
      {
        required: true,
        message: "请输入该股东/实控人的手机号",
        trigger: "blur",
      },
      {
        pattern:
